...
<div class="col-md-12">
	<div class="panel-search">
	  <form class="form-inline" action="/productAttributes/list">
	    <div class="form-group">
	      <label class="control-label">属性名：</label>
	      <input type="text" class="form-control" name="title">
	    </div>
	    <div class="form-group">
	      <label class="control-label">是否影响价格：</label>
	  ...
	  <div class="btn-div">
			<div class="div-left">
				<button type="button" class="btn btn-warning" onclick="add('/productAttributes/productAttributes')">
